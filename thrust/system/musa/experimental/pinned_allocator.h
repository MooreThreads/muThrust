...
/*! \file thrust/system/musa/experimental/pinned_allocator.h
 *  \brief An allocator which creates new elements in "pinned" memory with \p musaMallocHost
 */
  ...
  class pinned_allocator
{
  public:
                            ...
                            const_pointer = 0)
    {
      ...
      pointer result(0);
      musaError_t error = musaMallocHost(reinterpret_cast<void**>(&result), cnt * sizeof(value_type));
...
// alias musa's members at top-level
namespace musa
{
...
using thrust::system::musa::experimental::pinned_allocator;
