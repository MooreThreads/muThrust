...
#define THRUST_DEVICE_SYSTEM_MUSA    1
#define THRUST_DEVICE_SYSTEM_OMP     2
#define THRUST_DEVICE_SYSTEM_TBB     3
#define THRUST_DEVICE_SYSTEM_CPP     4

// MUSA 使用 MUSA 设备系统（共享实现）
// 不定义 THRUST_DEVICE_SYSTEM_MUSA，MUSA 编译时使用 THRUST_DEVICE_SYSTEM_MUSA
#ifndef THRUST_DEVICE_SYSTEM
#define THRUST_DEVICE_SYSTEM THRUST_DEVICE_SYSTEM_MUSA
#endif // THRUST_DEVICE_SYSTEM

// XXX make the use of THRUST_DEVICE_BACKEND an error in Thrust 1.7
// XXX eliminate the following in Thrust 1.7

#define THRUST_DEVICE_BACKEND_MUSA THRUST_DEVICE_SYSTEM_MUSA
