...
// MUSA: 添加 __MUSA_ARCH__ 支持
#if (defined(_NVHPC_CUDA) || defined(__CUDA_ARCH__) || defined(__MUSA_ARCH__)) && \
    THRUST_DEVICE_SYSTEM == THRUST_DEVICE_SYSTEM_MUSA
      ...
      ::allocate(typename temporary_allocator<T,System>::size_type cnt)
{
  ...
  if(result.second < cnt)
  {
    ...
    if (THRUST_IS_HOST_CODE) {
      ...
      #if THRUST_INCLUDE_DEVICE_CODE && THRUST_DEVICE_SYSTEM == THRUST_DEVICE_SYSTEM_MUSA
