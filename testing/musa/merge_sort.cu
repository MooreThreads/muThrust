...
void TestMergeSortKeySimple(void)
{
    ...
    thrust::stable_sort(unsorted_keys.begin(), unsorted_keys.end(), thrust::less<T>());
...
void TestMergeSortKeyValueSimple(void)
{
    ...
    thrust::stable_sort_by_key(unsorted_keys.begin(), unsorted_keys.end(), unsorted_values.begin(), thrust::less<T>());
...
void TestMergeSortDescendingKey(void)
{
    ...
    thrust::stable_sort(d_data.begin(), d_data.end(), thrust::greater<int>());
...
void TestMergeSortAscendingKeyValue(const size_t n)
{
    ...
    thrust::stable_sort_by_key(d_keys.begin(), d_keys.end(), d_values.begin(), thrust::less<T>());
...
void TestMergeSortDescendingKeyValue(void)
{
    ...
    thrust::stable_sort_by_key(d_keys.begin(), d_keys.end(), d_values.begin(), thrust::greater<int>());
...
void TestMergeSortKeyValue(size_t n)
{
  ...
  thrust::stable_sort(d_data.begin(), d_data.end(), thrust::less<T>());
