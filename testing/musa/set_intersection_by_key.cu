...
{
  TestSetIntersectionByKeyDevice(thrust::musa::par_nosync);
}
...
{
  TestSetIntersectionByKeyCudaStreams(thrust::musa::par);
}
...
{
  TestSetIntersectionByKeyCudaStreams(thrust::musa::par_nosync);
}
