...
{
  TestUniqueDevice(thrust::musa::par_nosync);
}
...
{
  TestUniqueCudaStreams(thrust::musa::par);
}
...
{
  TestUniqueCudaStreams(thrust::musa::par_nosync);
}
...
{
  TestUniqueCopyDevice(thrust::musa::par_nosync);
}
...
{
  TestUniqueCopyCudaStreams(thrust::musa::par);
}
...
{
  TestUniqueCopyCudaStreams(thrust::musa::par_nosync);
}
...
{
  TestUniqueCountDevice(thrust::musa::par_nosync);
}
...
{
  TestUniqueCountCudaStreams(thrust::musa::par);
}
...
{
  TestUniqueCountCudaStreams(thrust::musa::par_nosync);
}
