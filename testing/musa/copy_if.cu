...
{
  TestCopyIfDevice(thrust::musa::par_nosync);
}
...
void TestCopyIfCudaStreamsSync(){
  TestCopyIfCudaStreams(thrust::musa::par);
}
DECLARE_UNITTEST(TestCopyIfCudaStreamsSync);

void TestCopyIfCudaStreamsNoSync(){
  TestCopyIfCudaStreams(thrust::musa::par_nosync);
}
...
{
  TestCopyIfStencilDevice(thrust::musa::par_nosync);
}
...
{
  TestCopyIfStencilCudaStreams(thrust::musa::par);
}
...
{
  TestCopyIfStencilCudaStreams(thrust::musa::par_nosync);
}
