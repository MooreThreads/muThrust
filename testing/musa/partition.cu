...
{
  TestPartitionDevice(thrust::musa::par_nosync);
}
...
{
  TestPartitionStencilDevice(thrust::musa::par_nosync);
}
...
{
  TestPartitionCopyDevice(thrust::musa::par_nosync);
}
...
{
  TestPartitionCopyStencilDevice(thrust::musa::par_nosync);
}
...
{
  TestStablePartitionDevice(thrust::musa::par_nosync);
}
...
{
  TestStablePartitionStencilDevice(thrust::musa::par_nosync);
}
...
{
  TestStablePartitionCopyDevice(thrust::musa::par_nosync);
}
...
{
  TestStablePartitionCopyStencilDevice(thrust::musa::par_nosync);
}
...
{
  TestPartitionCudaStreams(thrust::musa::par);
}
...
{
  TestPartitionCudaStreams(thrust::musa::par_nosync);
}
