...
{
  TestUniqueByKeyDevice(thrust::musa::par_nosync);
}
...
{
  TestUniqueByKeyCudaStreams(thrust::musa::par);
}
...
{
  TestUniqueByKeyCudaStreams(thrust::musa::par_nosync);
}
...
{
  TestUniqueCopyByKeyDevice(thrust::musa::par_nosync);
}
...
{
  TestUniqueCopyByKeyCudaStreams(thrust::musa::par);
}
...
{
  TestUniqueCopyByKeyCudaStreams(thrust::musa::par_nosync);
}
